    ...
    <div className={styles.homeDesktopCadastrado}>
      <div className={styles.museus}>
          ...
          <div className={styles.museuDaImigraoDoEstadoDParent}>
            ...
            <div className={styles.venhaConferirAsContainer}>
              <p className={styles.venhaConferirAs}>
                ...
                Portinari nessa exposição, que ocorre de 14/06 até 07/08 no CCBB
                de Belo Horizonte!
              </p>
              <p
        ...
        <div className={styles.mainDialog}>
          ...
          <img className={styles.mainDialogItem} alt="" src="/polygon-1.svg" />
          ...
          <div className={styles.aPinacotecaDoContainer}>
            <p className={styles.venhaConferirAs}>
              ...
              importantes do Brasil. Fundado em 1905, obriga um acervo com cerca
              de 5000 obras, predominantemente de artistas brasileiros, com
              ênfase nas produções do século XIX. A coleção inclui pinturas,
              esculturas, fotografias, gravuras e desenhos de artistas
              renomados, como Almeida Júnior, Victor Meirelles, Anita Malfatti,
              Tarsila do Amaral, Candido Portinari, Di Cavalcanti e muitos
              outros. Além das exposições permanentes, a Pinacoteca também tem
              uma programação cultural diversificada, incluindo palestras,
              workshops, cursos e atividades educativas para o público de todas
              as idades.
            </p>
          </div>
        </div>
          ...
          <div className={styles.leftHallParent}>
            <div className={styles.leftHall}>
              <b className={styles.comoSurgiuAContainer}>
                <p className={styles.oEventoDemonstra}>Como surgiu a música?</p>
              </b>
              <div className={styles.desdeOsTempos}>
                ...
                utilizada em celebrações religiosas e rituais sociais. Enquanto
                na Grécia estava estreitamente ligada à poesia e ao teatro, a
                música romana era usada em cerimônias religiosas e festivais. 
              </div>
            </div>
            ...
            <div className={styles.leftHall2}>
              ...
              <div className={styles.oTtuloDessaContainer}>
                <p className={styles.oEventoDemonstra}>
                  ...
                  filmes internacionais da atualidade. Dirigido por Daniel Kwan
                  e Daniel Scheinert, e lançado em 11 de março de 2022, esse
                  longa ganhou 7 Oscars e mais 158 diferentes prêmios, se
                  tornando o longa-metragem mais premiado da história do cinema.
                </p>
              </div>
            </div>
          ...
          <div className={styles.hallContainer}>
            <div className={styles.leftHall3}>
              ...
              <div className={styles.quandoPensamosEm}>
                Quando pensamos em música clássica, imaginamos teatros repletos
                de pessoas da elite financeira apreciando concertos e óperas.
                Porém, esses pensamentos são estereotipados e o gênero musical é
                mais comum do que parece, estando presente em diversos conteúdos
                que consumimos diariamente. Vamos descobrir então como os
                clássicos agregam em diversos símbolos da cultura pop.
              </div>
            </div>
        ...
        <div className={styles.mainPortinari2}>
          ...
          <div className={styles.museuDaImigraoDoEstadoDParent}>
            ...
            <div className={styles.seVocEstContainer}>
              ...
              <p className={styles.oEventoDemonstra}>
                O cinema da avenida paulista, conta com um restaurante, um café
                e uma livraria, para você poder aproveitar outras coisas além do
                filme, sem contar que ele é um dos únicos cinemas da capital que
                exibem essas produções independentes.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={styles.hallContainer}>
            <div className={styles.leftHall4}>
              ...
              <div className={styles.atualmenteOsJogos}>
                ...
                outros os utilizam como uma forma de fugir da realidade e lidar
                com seus problemas.  
              </div>
            </div>
      ...
      <div className={styles.m34}>
        ...
        <div className={styles.leftHall6}>
          ...
          <div className={styles.muitoPopularPor}>
            ...
            publicadas pela autora. Lançado em 1977, é recordado até hoje como
            um clássico nacional e já foi traduzido para outras línguas,
            adequando-o para venda internacional.
          </div>
        </div>
        <div
            ...
            <div className={styles.leftHall7}>
              ...
              <div className={styles.oBrasilPossuiContainer}>
                <p className={styles.oEventoDemonstra}>
                  ...
                  quanto por possuir uma grande variedade de opções, São Paulo é
                  considerado a capital gastronômica do Brasil.
                </p>
          ...
          <div className={styles.hallContainer}>
            <div className={styles.leftHall4}>
              ...
              <div className={styles.cidadeDeDeus1}>
                Cidade de Deus, dirigido por Fernando Meirelles e Kátia Lund, e
                lançado em 30 de agosto 2002, é um dos clássicos do cinema
                brasileiro.
              </div>
            </div>
            <div className={styles.tagFilmes2}>
        ...
        <div className={styles.mainDialog}>
          ...
          <div className={styles.aPinacotecaDoContainer}>
            <p className={styles.venhaConferirAs}>
              ...
              impactará sua vida d e forma surpreendente, que ocorre de 17/06 a
              22/07. O passeio dura pouco mais de uma hora, mas os efeitos podem
              durar uma vida!
            </p>
            <p className={styles.oEventoDemonstra}>
              {" "}
              O projeto consiste numa trajetória guiada por deficientes visuais,
              em grupos, por salas totalmente escuras em que apenas o cheiro, o
              som, o vento, a temperatura e a textura são suficientes para
              interagir e interpretar com o meio ambiente, apresentando à
              sociedade um ambiente cotidiano dessas pessoas. A causa gera um
              forte impacto social e emocional para quem visita essa exposição.
            </p>
          </div>
        </div>
        <div className={styles.head}>
